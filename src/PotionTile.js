...
const PotionTile = (props) => {
  ...
  const className = props.isInventory ? "inventory-card" : "card";

  return (
    <div key={props.potion.id} className={className}>
      <div onClick={() => props.handleClick(props.potion.id)} className="image-wrapper">
